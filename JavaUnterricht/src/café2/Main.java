...
public class Main {
	...
	public static void main(String[] args) {
		...
		while(true) {
			System.out.println("Was möchten Sie bestellen? Geben Sie einen Kaffee an oder schreiben Sie Exit, um die Bestellung zu beenden.");
			System.out.println("Wenn Sie eine Bestellung stornieren möchten geben Sie Storno und den Kaffeenamen ein.");
			System.out.println("-----------");
			...
			try {
				...
				if(eingabe.equals(americano.getName())) {
					...
					System.out.println("Sie müssen " + americano.getPrice() + " Euro" + " bezahlen.");
					kaffeeBestellungen.add(eingabe);
					kasse += americano.getPrice();
				}
				else if(eingabe.equals(espresso.getName())) {
					System.out.println("Sie haben " + eingabe + " bestellt.");
					System.out.println("Sie müssen " + espresso.getPrice() + " Euro" + " bezahlen.");
					kaffeeBestellungen.add(eingabe);
					kasse += espresso.getPrice();
				}
				else if(eingabe.equals(latteMachiato.getName())) {
					System.out.println("Sie haben " + eingabe + " bestellt.");
					System.out.println("Sie müssen " + latteMachiato.getPrice() + " Euro" + " bezahlen.");
					kaffeeBestellungen.add(eingabe);
					kasse += latteMachiato.getPrice();
				}
				
				else if(eingabe.equals("Storno")) {
					System.out.println("Welche Bestellung möchten Sie stornieren?");
